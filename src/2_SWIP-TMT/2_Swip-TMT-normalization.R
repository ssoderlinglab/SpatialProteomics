...
renv::activate("~/soderlinglab/user/pooja/projects/SpatialProteomics/src/2_SWIP-TMT")
# Necessary packages
...
# Input data file
input_data <- "Transformed_LOPIT_concat_young.csv"
...
# Map all Uniprot Protein numbers to stable ntrez IDs
...
entrez[names(last_entrez_map)] <- last_entrez_map
...
message("Missing entrez:\n", paste(names(entrez)[is.na(entrez)], collapse = "\n"))
