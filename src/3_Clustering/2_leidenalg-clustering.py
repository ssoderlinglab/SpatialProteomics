...
'''
This is now being adapted to the work with Daichi Shonai on Parkinson's related
genes such as Vps35, SNCA, and LRRK2.
...
adjm_file = 'concat_ne_adjm.csv' # change
LOAD=False
...
genename =adjm_file.split("_")[0]
output_name = genename
...
#   for resolution in tqdm(res_range):
        # optimize partition
