...
setwd("~/soderlinglab/user/pooja/projects/SpatialProteomics/src/3_Clustering")

## Change to your gene name
gene_name <- "" # change
load(file.path(data_dir, "concat_tmt.rda"))
load(file.path(data_dir, "concat_gene_map.rda"))                                                                                                                     
## ---- Output:
